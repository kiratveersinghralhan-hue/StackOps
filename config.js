// StackOps Arena Pro config
// Replace these with your Supabase + Razorpay test credentials.
window.STACKOPS_CONFIG = {
  ...
  DEFAULT_LANGUAGE: 'en',
  COMMISSION_RULES: [
    { min: 0, max: 499, rate: 7 },
    { min: 500, max: 999, rate: 10 },
    { min: 1000, max: 1999, rate: 15 },
    { min: 2000, max: 2999, rate: 20 },
    { min: 3000, max: 4999, rate: 25 },
    { min: 5000, max: 9999999, rate: 30 }
  ]
};
